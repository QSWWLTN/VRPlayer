...
public partial class VRPlayer : Node
{
    ...
    public override void _Process(double delta)
    {
        ...
        {
            GD.Print($"[VRPlayer] Actions - by:{Input.IsActionPressed("by_button")} menu:{Input.IsActionPressed("menu_button")} trigger:{Input.IsActionPressed("trigger_click")} ax:{Input.IsActionPressed("ax_button")}");
        }

        if (Input.IsActionJustPressed("by_button") || Input.IsActionJustPressed("menu_button") ||
            Input.IsActionJustPressed("ax_button"))
        {
